...
function Sidebar({ collapsible = "none", className, children, ...props }: SidebarProps) {
...
const SidebarHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex items-center overflow-hidden", className)} {...props} />
);
...
export {
  ...
  SidebarMenuItem, SidebarMenuButton, SidebarRail, SidebarTrigger, useSidebar,
};
