...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      'flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 gap-3 sm:gap-2',
      className
    )}
    {...props}
  />
